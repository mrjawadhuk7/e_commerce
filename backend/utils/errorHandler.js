...
class ErrorHandler extends Error{   //-->error thagavalai uruvakkakudiya class ithu 
    constructor(message,statusCode){//-->constructor la enna vaikkaramalo adhai arquements aga kodukkalam
        ...
        this.statusCode=statusCode;//statusCode class kku intha statusCode set pannanum 
        Error.captureStackTrace(this,this.constructor)//-->stack vandhu error handler class la thevaipadukirathu    
...
module.exports=ErrorHandler;   //-->error class oda constructor yai pass pannuren  
