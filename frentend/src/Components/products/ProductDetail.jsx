...
const {id} = useParams()
  ...
  <>
    ...
    {(product?.images && product.images.length > 0
      ? product.images
      : [{ _id: "default", image: "/images/default.png" }]  // fallback image
    ).map((image) => (
      <Carousel.Item key={image._id}>
        <img
  ...
  {/* <Carousel> */}
    {/* <Carousel.Item> */}
               {product?.images?.length > 0 ? (
                  <img src={product.images[0].image} alt="illaiye" height="500" width="500" />
...
export default ProductDetail;
                ...
                {/* <img src="/images/products/Sachein.jpg" alt="sdf" height="500" width="500"/> */}
